...
function renderProfileReference(){
  ...
  if($('knownName'))$('knownName').textContent=ctx.name||'Not provided';
  if($('knownAccountType'))$('knownAccountType').textContent=ctx.accountType||'Not provided';
  if($('knownIndustry'))$('knownIndustry').textContent=ctx.industry||'Not provided';
  if($('knownPlatform'))$('knownPlatform').textContent=platform||'Not provided';
  if($('knownHandle'))$('knownHandle').textContent=handle||'Not provided';
  if($('knownWebsite'))$('knownWebsite').textContent=ctx.website||'Not provided';
  if($('knownGoal'))$('knownGoal').textContent=ctx.goal||'Not provided';
}
